...
func (_m *MockRepository) ReadSlug(ctx context.Context, slug string) (*Model, error) {
...
// MockRepository_ReadSlug_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ReadSlug'
type MockRepository_ReadSlug_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - slug string
func (_e *MockRepository_Expecter) ReadSlug(ctx interface{}, slug interface{}) *MockRepository_ReadSlug_Call {
	return &MockRepository_ReadSlug_Call{Call: _e.mock.On("ReadSlug", ctx, slug)}
}

func (_c *MockRepository_ReadSlug_Call) Run(run func(ctx context.Context, slug string)) *MockRepository_ReadSlug_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockRepository_ReadSlug_Call) Return(_a0 *Model, _a1 error) *MockRepository_ReadSlug_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

// SlugExists provides a mock function with given fields: ctx, slug
func (_m *MockRepository) SlugExists(ctx context.Context, slug string) (bool, error) {
	ret := _m.Called(ctx, slug)
...
// MockRepository_SlugExists_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SlugExists'
type MockRepository_SlugExists_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - slug string
func (_e *MockRepository_Expecter) SlugExists(ctx interface{}, slug interface{}) *MockRepository_SlugExists_Call {
	return &MockRepository_SlugExists_Call{Call: _e.mock.On("SlugExists", ctx, slug)}
}

func (_c *MockRepository_SlugExists_Call) Run(run func(ctx context.Context, slug string)) *MockRepository_SlugExists_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockRepository_SlugExists_Call) Return(_a0 bool, _a1 error) *MockRepository_SlugExists_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
